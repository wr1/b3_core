...
- [Resin halo](/docs/concepts/resin-halo) — opened-cell band + graphics (`P(d)`, side cut, 3D); textile `grid_scored` / `.with_halo`.
- [Kerf open & close](/docs/concepts/curvature) — mould curvature opens/pinches grooves; local homogenization.
- [Halo + curvature](/docs/concepts/halo-curvature) — one `hw(z)` law; halo on tapered walls; **Eyy vs κ × cell_size**; surrogates.
