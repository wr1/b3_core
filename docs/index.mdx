...
- [Halo + curvature](/docs/concepts/halo-curvature) — one `hw(z)` law; halo grades off the tapered wall; **Eyy vs κ × cell_size**.
...
Repo-root `SKILL.md` (also packaged as `b3_core/SKILL.md`) lets LLMs drive homogenization end-to-end:
