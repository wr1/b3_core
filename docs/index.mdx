...
flowchart TB
  ...
  subgraph solve[Six unit strains]
    direction LR
    bc[periodic BC] ~~~ be[ccx / mfem / fenicsx / numpy]
  end
...
3. Solve six unit macroscopic strains under periodic BC.
4. Average reactions and face jumps → orthotropic constants and infused density.
...
The package ships an agent skill (`SKILL.md`) so LLMs can drive homogenization end-to-end:
